...
def load_users():
    ...
    users = {}
    try:
        with open('/opt/Iron_Ring_TUI/users.txt', 'r') as f:
            for line in f:
                line = line.strip()
                if line and ':' in line:
...
def load_permissions():
    ...
    permissions = {}
    try:
        with open('/opt/Iron_Ring_TUI/permissions.txt', 'r') as f:
            for line in f:
                line = line.strip()
                if line and ':' in line:
...
def load_user_holos():
    ...
    holos = {}
    try:
        with open('/opt/Iron_Ring_TUI/user_holos.txt', 'r') as f:
            for line in f:
                line = line.strip()
                if line and ':' in line:
...
def save_user_holos(holos):
    ...
    try:
        with open('/opt/Iron_Ring_TUI/user_holos.txt', 'w') as f:
...
def station_news():
    ...
    try:
        with open('/opt/Iron_Ring_TUI/news.txt', 'r') as f:
            news_articles = []
            for line in f:
                line = line.strip()
                if line and '|' in line:
...
def food_delivery():
    ...
    # Load food menu
    try:
        with open('/opt/Iron_Ring_TUI/food_menu.txt', 'r') as f:
            food_items = []
            for line in f:
                line = line.strip()
                if line and '|' in line:
        ...
        if 1 <= choice <= len(food_items):
            ...
            if user_balance >= price:
                ...
                if save_user_holos(holos):
                    ...
                    try:
                        with open('/opt/Iron_Ring_TUI/user_inventory.txt', 'a') as f:
...
def view_maintenance_notes():
    ...
    try:
        with open('/opt/Iron_Ring_TUI/maintenance_notes.txt', 'r') as f:
            notes = []
            for line in f:
                line = line.strip()
                if line and '|' in line:
...
def view_inventory():
    ...
    try:
        with open('/opt/Iron_Ring_TUI/user_inventory.txt', 'r') as f:
            user_items = []
            for line in f:
                line = line.strip()
                if line and ':' in line:
            ...
            if 1 <= choice <= len(user_items):
                ...
                if Confirm.ask(f"[bold red]Confirm deletion of '{selected_item}'?[/bold red]"):
                    ...
                    if item_found:
                        ...
                        with open('/opt/Iron_Ring_TUI/user_inventory.txt', 'w') as f:
